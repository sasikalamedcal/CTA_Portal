                                                ...
                                                <div class="col-sm-12">
                                                    <select class="form-control" name="fld_leadsource" required>
                                                       <option value="">Please Select Lead Source</option>
                                                        ...
                                                        <option value="{{$leadsource->lead_id}}">{{$leadsource->lead_source}}</option>
                                                        @endforeach
                                                    </select>
...
$("#addmore").on('click',function(){
	...
	html = '<tr>';
	<!--html += '<td>' + counter +'</td>';-->
	html += '<td><select id="lender" class="form-control" name="data['+counter+'][lender]"><option value="">Please Select Lender</option>@foreach($lenders as $lender)<option value="{{$lender->lender}}"> {{$lender->lender}} </option>@endforeach</select></td>';
	html += '<td><select class="form-control col-sm-12" name="data['+counter+'][account]" id="account"><option value="">Please Select Account Type</option>@foreach($accounts as $account)<option value="{{$account->account}}"> {{$account->account}} </option>@endforeach</select></td>';
	html += '<td><a class="btn btn-danger delete" id="delete"> x </a></td>';
	html += '</tr>';
