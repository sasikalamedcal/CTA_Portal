...
<div class="card">
    <div class="card-header">
        <h5>Account Type INFORMATION</h5>
        <div class="card-header-right">
               <form action="{{ url('accounts/create')}}" method="post" style="display: inline-block">
                @csrf
                @method('GET')
...
<tr>
    ...
    @endif
     ...
     <td>
    <form action="{{ url('accounts/edit', $account->id)}}" method="post" style="display: inline-block">
        @csrf
        @method('GET')
    ...
    <td>
        <form action="{{ url('accounts/destroy', $account->id)}}" method="post" style="display: inline-block">
        @csrf
        @method('DELETE')
